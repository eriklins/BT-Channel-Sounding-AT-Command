...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_COUNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_MAX_ANTENNA_PATHS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_NUM_ANTENNAS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_MULTIPLE_ANTENNA_SUPPORT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RREQ_MAX_ACTIVE_CONN, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_AUTO_ALLOC_INSTANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_MAX_ACTIVE_CONN, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_SIZE, 3840);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_CNT, 4);
